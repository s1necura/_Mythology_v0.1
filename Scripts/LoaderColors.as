...
namespace map_colors
{
	enum color
	{
		...
		Beholder         = 0xFF6700BC, // ARGB(255,  56,  76, 142);
		FireSiphon         = 0xFFFF2B00, // ARGB(255,  56,  76, 142);
		Automaton         = 0xFF334847, // ARGB(255,  56,  76, 142);
		Zombie         = 0xFF677235, // ARGB(255,  56,  76, 142);
		Greg         = 0xFF535E63, // ARGB(255,  56,  76, 142);
		Kraken         = 0xFFEC6D8F, // ARGB(255,  56,  76, 142);
		Kobold         = 0xFF743A52, // ARGB(255,  56,  76, 142);

		//CaveDecorations
		Corpse                   = 0xFF4E2624, // ARGB(255,  91, 126,  24);

		//Decorations
		ArcL                   = 0xFF3A2F2A, // ARGB(255,  91, 126,  24);
		ArcR                   = 0xFF413A2A, // ARGB(255,  91, 126,  24);

		Bake                   = 0xFF3A2620, // ARGB(255,  91, 126,  24);
		Flue                   = 0xFF382D2A, // ARGB(255,  91, 126,  24);
		Bed                   = 0xFF372300, // ARGB(255,  91, 126,  24);
		Table                   = 0xFF684200, // ARGB(255,  91, 126,  24);
		Bookshelf                   = 0xFF7F1700, // ARGB(255,  91, 126,  24);
		ArmorStand                   = 0xFF00597C, // ARGB(255,  91, 126,  24);
		WeaponStand                   = 0xFF493024, // ARGB(255,  91, 126,  24);
		Window                   = 0xFF677467, // ARGB(255,  91, 126,  24);
		Anvil                   = 0xFF352F2E, // ARGB(255,  91, 126,  24);
		Firewood                   = 0xFF380C00, // ARGB(255,  91, 126,  24);
		PottedPlant                   = 0xFF64610D, // ARGB(255,  91, 126,  24);

		Tiledirt                   = 0xFF705035, // ARGB(255,  91, 126,  24);
		HayLeft1                   = 0xFFE0AE43, // ARGB(255,  91, 126,  24);
		HayLeft2                   = 0xFFD6A140, // ARGB(255,  91, 126,  24);
		HayLeft3                   = 0xFFC1843A, // ARGB(255,  91, 126,  24);
		HayRight1                   = 0xFFDDC342, // ARGB(255,  91, 126,  24);
		HayRight2                   = 0xFFD3B63F, // ARGB(255,  91, 126,  24);
		HayRight3                   = 0xFFBF993B, // ARGB(255,  91, 126,  24);
		WoodenBeam                   = 0xFF683314, // ARGB(255,  91, 126,  24);
		WoodenBeamR                   = 0xFF662F14, // ARGB(255,  91, 126,  24);
		SideBeam                   = 0xFFC47C1F, // ARGB(255,  91, 126,  24);
		SideBeamR                   = 0xFFC1931F, // ARGB(255,  91, 126,  24);

		HollowKeg                   = 0xFF773717, // ARGB(255,  91, 126,  24);
		SmallCrate                   = 0xFF492B14, // ARGB(255,  91, 126,  24);
		Sake                   = 0xFF6D3913, // ARGB(255,  91, 126,  24);
		Boiler                   = 0xFF312A2C, // ARGB(255,  91, 126,  24);
		SeedCrate                   = 0xFF1C280D, // ARGB(255,  91, 126,  24);
		ShelfofIngredients                   = 0xFF77996C, // ARGB(255,  91, 126,  24);

		//Entity
		Trader                   = 0xFF32D6FF, // ARGB(255,  91, 126,  24);

		// FLORA
		BackBushyTree                   = 0xFF1B1F24, // ARGB(255,  91, 126,  24);
